...
if(isset($_POST['btn_register'])){
    ...
    $res = mysqli_query($conn, $sql);
        ...
        $message = "Congrats ".$fname." <br> You are successfully registered on Complain Management System, you can now login and forward your complain. <br><br><br><b>Group 7 and 8 Team.</b>";
...
$mail->Subject = $subject;
//Set sender email
$mail->setFrom('ibrobk@gmail.com', "KEDCO  Management");
//Enable HTML
$mail->isHTML(true);
//Attachment
// $mail->addAttachment('img/attachment.png');
